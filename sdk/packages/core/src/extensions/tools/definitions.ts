...
export function createAskQuestionTool(
	...
	return {
		...
		description:
			...
			"Mark the option you would pick: end it with ' (recommended)' and say why in one sentence in the question. " +
			"Mark exactly one. Leave every option unmarked only when the choice turns on the user's taste or on something only they know. " +
