...
describe("FileContextTracker", () => {
	...
	it("should add a record when a file is edited by Cerebriline", async () => {
	...
	it("should not track Cerebriline edits as user edits", async () => {
		// First track the file to set up the watcher
		await tracker.trackFileContext(filePath, "read_tool")

		// Mark the file as edited by Cerebriline
