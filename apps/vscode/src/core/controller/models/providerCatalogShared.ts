	...
	return ProviderConfigResponse.create({
		...
		reasoning: config.reasoning
			? {
					...
					reasoningInline: config.reasoning.reasoningInline,
				}
			: undefined,
...
function toPolykvSettings(patch: NonNullable<WriteProviderConfigPatch["polykv"]>): PolykvSettings {
	...
	return {
		...
		...(patch.continuationCompaction !== undefined ? { continuationCompaction: patch.continuationCompaction } : {}),
			...
			? {
					reasoning: {
						...
						...(protoPatch.reasoning.budgetTokens !== undefined
							...
							: {}),
						...(protoPatch.reasoning.reasoningInline !== undefined
							? { reasoningInline: protoPatch.reasoning.reasoningInline }
							: {}),
